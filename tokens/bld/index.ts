...
const TOKEN_NAME = "GAMECOIN";
const TOKEN_SYMBOL = "GAME";
const TOKEN_DESCRIPTION = "A token for gamers";
const TOKEN_IMAGE_NAME = "gamecoin.png"; // Replace unicorn.png with your image name
